...
export const INDUSTRIES = [
  {
    ...
    growth: 'Business count is broadly flat (+0.1%), but detached-house building is forecast to grow about 2.1% a year and record infrastructure pipelines keep civil contractors busy, so the accounting work per firm is rising even where firm numbers are steady.[[3]]',
  ...
  },
  {
    ...
    growth: 'Cafe, restaurant and bar revenue is growing roughly 5.8% a year as dining-out demand recovers, and franchising keeps adding multi-site operators who need consolidated reporting.[[4]]',
  ...
  },
  {
    ...
    growth: 'Sector revenue grew about 4.4% annualised to 2024-25, with convenience retail the key margin driver and consolidation into branded networks creating multi-site groups that need professional accounting.[[5]]',
  ...
  },
  {
    ...
    growth: 'One of the fastest-growing divisions, up 7.7% in a single year, with an ageing population, the NDIS, and aged-care demand all driving a structural, long-run expansion in the number of practices and providers.[[2]][[6]]',
  ...
  },
  {
    ...
    growth: 'Consumer-goods retailing is a $271B sector, and the steady shift to e-commerce keeps adding online and hybrid sellers whose multi-channel reconciliation and forecasting needs are heavier than a single shopfront.[[7]]',
  ...
  },
  {
    ...
    growth: 'The fastest-growing division by business count, up 8.5% in a single year, propelled by e-commerce last-mile delivery and a wave of new owner-driver and courier ABNs that each need bookkeeping, BAS, and fuel tax credit work.[[2]]',
  ...
  },
  {
    ...
    growth: 'A top-three division by count and structurally expanding as the economy tilts toward knowledge, digital, and professional services, adding exactly the kind of high-margin, advisory-hungry firms that make the best long-term clients.[[9]]',
...
export const FORMATION = {
  ...
  states: [
    ...
    { l: 'New South Wales', v: '+1.9%', w: 44, note: 'Largest absolute gain; 916,603 total businesses[[1]]' },
  ],
  metros: [
    { l: 'Greater Sydney (NSW)', v: '+20,040', w: 100, note: 'Largest absolute gain in the country; NSW now holds 916,603 businesses[[1]]' },
    { l: 'Greater Melbourne (VIC)', v: '+16,486', w: 82, note: 'Second-largest gain nationally; Victoria added more businesses than any state but NSW[[1]]' },
    { l: 'Greater Brisbane (QLD)', v: '+13,579', w: 68, note: 'A 2.7% rise; Queensland is the top destination for businesses relocating interstate[[1]]' },
  ],
  note: 'Even with churn, the base grows every year, and growth is concentrated in the three eastern-seaboard capitals where most businesses, and most accounting demand, already sit. Sydney and Melbourne added the largest absolute numbers of new businesses in the country, while Brisbane anchors a city economy worth more than $200 billion and a state that attracts more interstate businesses than any other, with the 2032 Olympics underwriting a decade of investment.[[1]][[11]] Each net new business is a new, recurring accounting annuity.',
};
